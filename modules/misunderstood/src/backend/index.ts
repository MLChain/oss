...
const EVENT_NAME: keyof MlchainCoreEvents = 'bp_core_feedback_negative'
let listener: (arg: MlchainCoreEvents['bp_core_feedback_negative']) => void
...
const onServerReady = async (bp: typeof sdk) => {
  ...
  process.MLCHAIN_EVENTS.on(EVENT_NAME, listener)
}

const onModuleUnmount = async (_bp: typeof sdk) => {
  process.MLCHAIN_EVENTS.off(EVENT_NAME, listener)
}
