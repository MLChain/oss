import ReactMessageRenderer, { defaultMessageConfig } from '@mlchain/messaging-components'
...
export default class Message extends React.Component<{ message: HitlMessage }> {
  ...
  renderMessage() {
    ...
    let messageFrom = 'bot'
    if (direction === 'in') {
      // TODO: Visit and session reset are currently unsupported by @mlchain/messaging-components
      if (type === 'visit') {
        return (
