...
import { Dialog, lang, toast } from 'mlchain/shared'
...
export default class BroadcastModule extends React.Component {
  ...
  renderFormContent() {
    const pickContent = () => window.mlchain.pickContent({}, this.handleContentChange)
          ...
          label={
            <div>
              ...
              <a
                ...
                href="https://github.com/mlchain/oss/blob/master/modules/broadcast/README.md#filtering"
              >
                <Icon icon="help" />
              </a>
            </div>
