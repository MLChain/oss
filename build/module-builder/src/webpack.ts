...
const libraryTarget = mod => `mlchain = typeof mlchain === "object" ? mlchain : {}; mlchain["${mod}"]`
...
export function config(projectPath) {
  ...
  const full: webpack.Configuration = {
    ...
    externals: {
      ...
      'mlchain/ui': 'MlchainUI',
      'mlchain/content-picker': 'MlchainContentPicker',
      'mlchain/documentation': 'DocumentationProvider',
      'mlchain/utils': 'MlchainUtils',
      'mlchain/shared': 'MlchainShared'
    },
    resolveLoader: {
