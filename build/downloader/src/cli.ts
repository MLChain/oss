...
export const toolsList = {
  nlu: {
    url: 'https://api.github.com/repos/mlchain/nlu/releases'
  },
  studio: {
    url: 'https://api.github.com/repos/mlchain/studio/releases'
  },
  messaging: {
    url: 'https://api.github.com/repos/mlchain/messaging/releases'
  }
}
...
export const cleanFiles = async (storageLocation: string) => {
  try {
    ...
    logger.info('Mlchain Tools successfully removed')
  } catch (err) {
