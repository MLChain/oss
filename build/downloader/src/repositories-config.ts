...
export const getConfig = (rootFolder: string): RepositoriesConfig => {
  return {
    mlchain: {
      favorites: [
        path.resolve(rootFolder, 'mlchain/packages/bp/dist/data'),
        path.resolve(rootFolder, 'mlchain/packages/bp/dist/.env'),
        path.resolve(rootFolder, 'mlchain/packages/bp/dist/data/global/mlchain.config.json')
      ],
      dotEnvFile: {
        location: path.resolve(rootFolder, 'mlchain/packages/bp/dist/'),
