...
const DownloadLinks: FC<{ version: string; dockerUrl: string }> = props => {
  ...
  return (
    <div className={style.downloads}>
      Download binary
      <hr />
      <a href={`https://s3.amazonaws.com/mlchain-binaries/mlchain-${version}-darwin-x64.zip`} target="_blank">
        <img src={mac} /> Mac
      </a>
      <br />
      <a href={`https://s3.amazonaws.com/mlchain-binaries/mlchain-${version}-win-x64.zip`} target="_blank">
        <img src={window} /> Windows
      </a>
      <br />
      <a href={`https://s3.amazonaws.com/mlchain-binaries/mlchain-${version}-linux-x64.zip`} target="_blank">
        <img src={linux} /> Linux
      </a>
      <br />
      <br />
      Docker Image
      <hr />
      <a href={props.dockerUrl || 'https://hub.docker.com/r/mlchain/server'} target="_blank">
        <code>mlchain/server:{version}</code>
      </a>
    </div>
  )
}
