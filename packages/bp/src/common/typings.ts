import { BotDetails, Flow, FlowNode, IO, RolloutStrategy, StageRequestApprovers, StrategyUser } from 'mlchain/sdk'
import { Request, Response } from 'express'
import { MlchainConfig } from '../core/config/mlchain.config'
...
export interface IInitializeFromConfig {
  initializeFromConfig(config: MlchainConfig): void
}
...
export interface ModuleInfo {
  ...
  archived?: boolean
  /** The location of the module as listed in mlchain config */
  location: string
