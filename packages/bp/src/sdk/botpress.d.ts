/**
 * This is the official Mlchain SDK, designed to help our fellow developers to create wonderful modules and
...
declare module 'mlchain/sdk' {
  ...
  /**
   * Returns the current version of Mlchain
   */
  export const version: string

  /**
   * This variable gives you access to the Mlchain database via Knex.
   ...
   * of the module. The path to the module must also be specified in the global mlchain config.
   */
  export interface ModuleEntryPoint {
    ...
    onServerStarted?: (bp: typeof import('mlchain/sdk')) => Promise<void>
    /** This is called once all modules are initialized, usually for routing and logic */
    onServerReady?: (bp: typeof import('mlchain/sdk')) => Promise<void>
    onBotMount?: (bp: typeof import('mlchain/sdk'), botId: string) => Promise<void>
    onBotUnmount?: (bp: typeof import('mlchain/sdk'), botId: string) => Promise<void>
    /**
     * Called when the module is unloaded, before being reloaded
     * onBotUnmount is called for each bots before this one is called
     */
    onModuleUnmount?: (bp: typeof import('mlchain/sdk')) => Promise<void>
    /**
     ...
     */
    onTopicChanged?: (
      bp: typeof import('mlchain/sdk'),
      botId: string,
      oldName?: string,
      newName?: string
    ) => Promise<void>
    onFlowChanged?: (bp: typeof import('mlchain/sdk'), botId: string, flow: Flow) => Promise<void>
    onFlowRenamed?: (
      bp: typeof import('mlchain/sdk'),
      botId: string,
  ...
  export interface BotTemplate {
    ...
    desc: string
    /** These are used internally by Mlchain when they are registered on startup */
  ...
  export namespace IO {
    ...
    export namespace WellKnownFlags {
      ...
      /** When this flag is active, Mlchain Native NLU will not process this event */
    ...
    /**
     * A MlchainEvent is how conversational channels interact with Mlchain. Events represent all the interactions
    ...
    export interface EventState {
      /** Data saved as user attributes; retention policies in Mlchain global config applies  */
      user: any
       ...
       */
      bot: any
      /** Used internally by Mlchain to keep the user's current location and upcoming instructions */
  ...
  export interface MessagingConfig {
     ...
     * You can find more about channel configurations here : https://mlchain.com/docs/channels/faq
     */
  ...
  export interface ConverseConfig {
    ...
    /**
     * Whether or not you want to expose public converse API. See docs here https://mlchain.com/docs/channels/converse#public-api
     * @default ture
     */
   ...
   * tells mlchain how to display the content on various channels
   */
  ...
  export interface FlowGenerationResult {
     ...
     * once the flow is sent to Mlchain, the final product will be a Flow.
     */
    flow: SkillFlow
  ...
  /** These are additional information that Mlchain may pass down to migrations (for ex: running bot-specific migration) */
  ...
  export namespace config {
    ...
    /**
     * Returns the configuration options of Mlchain
     */
    export function getMlchainConfig(): Promise<any>
  ...
  export namespace security {
    /**
     * Creates a message signature, which can be used as proof that the message was created on Mlchain backend
