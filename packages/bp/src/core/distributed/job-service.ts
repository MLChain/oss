import { RedisLock } from 'mlchain/sdk'
...
export interface JobService {
  /**
   * * In Mlchain Pro, this allows to broadcast a job to execute to all distributed nodes.
   ...
   *
   * * In Mlchain CE, the function will be returned directly.
