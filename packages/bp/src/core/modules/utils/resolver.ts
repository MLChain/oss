import { Logger, ModuleEntryPoint } from 'mlchain/sdk'
...
if (process.pkg) {
  ...
  // Running mlchain in packages mode
...
export class ModuleResolver {
  ...
  /**
   * Resolves the real absolute path of a module from a path defined in [`mlchain.config.json`]{@see MlchainConfig}
   * @private
