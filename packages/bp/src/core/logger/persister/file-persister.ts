import { Logger, LoggerEntry } from 'mlchain/sdk'
...
export class LoggerFilePersister {
  ...
  async initialize(mlchainConfig: MlchainConfig, logger: Logger) {
    const logsConfig = _.get(mlchainConfig, 'logs.fileOutput', {})
