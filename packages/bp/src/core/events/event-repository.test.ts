...
describe('Event Repository', () => {
  ...
  it('should call MLCHAIN_CORE_EVENT with correct event details', async () => {
    global.MLCHAIN_CORE_EVENT = jest.fn()
    ...
    expect(global.MLCHAIN_CORE_EVENT).toHaveBeenLastCalledWith('bp_core_feedback_positive', {
    ...
    expect(global.MLCHAIN_CORE_EVENT).toHaveBeenLastCalledWith('bp_core_feedback_negative', {
      botId: storedEvent.botId,
      channel: storedEvent.channel,
      type: eventType,
      eventId: storedEvent.id,
