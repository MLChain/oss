...
declare module 'mlchain/sdk' {
  ...
  export interface ModuleEntryPoint {
    ...
    onServerStarted: (bp: typeof import('mlchain/sdk')) => void
    /** This is called once all modules are initialized, usually for routing and logic */
    onServerReady: (bp: typeof import('mlchain/sdk')) => void
    onBotMount?: (bp: typeof import('mlchain/sdk'), botId: string) => void
    onBotUnmount?: (bp: typeof import('mlchain/sdk'), botId: string) => void
    ...
    onFlowChanged?: (bp: typeof import('mlchain/sdk'), botId: string, flow: Flow) => void
  }
