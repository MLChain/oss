...
In your `mlchain.config.json` file:
...
You can configure additional options when using this authentication strategy. Please refer to the [configuration file for more information](https://github.com/mlchain/oss/blob/master/packages/bp/src/core/config/mlchain.config.ts#L350) :
