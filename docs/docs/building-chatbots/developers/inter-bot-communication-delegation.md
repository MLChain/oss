...
The code for this example is available in the [examples](https://github.com/mlchain/oss/tree/master/examples/interbot) directory of our GitHub repository (update `workspaces.json` with the three bots if you copied them).
...
The action you need to create [can be found here](https://github.com/mlchain/oss/tree/master/examples/interbot/bots/master/actions/delegate_to_bots.js). Just copy and paste this file in your `<data>/bots/master/actions` directory.
...
:::tip
The reason we use triple mustaches (`{{{ ... }}}`) is to prevent Mlchain from escaping the special characters found in the variables.
:::
